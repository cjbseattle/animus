...
import { Home, BookMarked, ShoppingBag, BarChart2 } from "lucide-react";
...
export function BottomNav() {
  ...
  const links = [
    ...
    { href: "/questions", icon: BookMarked, label: "Questions" },
        ...
        {links.map((link) => {
          ...
          return (
            <Link key={link.href} href={link.href} className="flex-1 flex justify-center">
              ...
              >
                <Icon
                  className={cn("w-5 h-5", isActive && "drop-shadow-[0_0_8px_rgba(0,255,255,0.5)]")}
